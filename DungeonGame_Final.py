...
def start_DungeonGame():
    ...
    while True:
        ...
        print(f"Hallo {naam}! Welkom bij het begin van je reis! \n"
              ...
              f'De artefact kan gebruikt worden om jezelf te beschermen tegen vijanden. Jij vind dit artefact zo bijzonder, datje daarvoor op wereldreis gaat.\n'
